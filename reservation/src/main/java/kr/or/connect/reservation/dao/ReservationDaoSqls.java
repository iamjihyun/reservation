...
public class ReservationDaoSqls {
	public static final String SELECT_PAGING = "SELECT * FROM product p join category c on(c.id=p.category_id) WHERE CATEGORY_ID = :cate ORDER BY id DESC limit :start, :limit";
